...
#Coefficient de réduction du nombres de coeurs(ex: x.cores=0.5 ==> la moitié des coeurs utilisables)
#Coefficient de réduction de la RAM
#Erreur relative au calcul de la mémoire par coeur.
